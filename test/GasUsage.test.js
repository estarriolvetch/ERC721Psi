...
describe('ERC721PsiGasReporterMock', createTestSuite({
  contract: 'ERC721PsiGasReporterMock',
  constructorArgs: ['ERC721Psi', 'ERC721Psi'],
}));

describe('ERC721PsiGasReporterMockUpgradeable', createTestSuite({
  contract: 'ERC721PsiGasReporterMockUpgradeable',
  constructorArgs: ['ERC721Psi', 'ERC721Psi'],
}));
